                        ...
                        <h2 class="text-lg font-medium text-gray-900 border-b pb-2">Información de la cita</h2>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-medium text-gray-900">{{ $appointment->schedule->date }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-medium text-gray-900">{{ ucfirst($appointment->schedule->day) }}</p>
                                </div>

                                <!-- Paciente -->
                                <div>
                                    <p class="text-sm text-gray-500">Paciente:</p>
                                    <p class="text-lg font-medium text-gray-900">{{ $appointment->patient->name }} {{ $appointment->patient->surnames }}</p>
                                </div>
                                ...
                                @if (auth()->user()->role === 'admin')
                                    <div>
                                        ...
                                        <p class="text-lg font-medium text-gray-900">{{ $appointment->doctor->name }} {{ $appointment->doctor->surnames }}</p>
                                    </div>
                                @endif
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-medium text-gray-900">{{ $appointment->details ?? 'Sin detalles' }}</p>
                                </div>
                            </div>
                    </div>
                </div>
