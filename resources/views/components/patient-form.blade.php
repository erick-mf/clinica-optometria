                ...
                <div class="flex flex-wrap sm:flex-nowrap gap-4 items-start">
                    <div class="w-full sm:w-[40%]">
                        ...
                        <select id="document_type" name="document_type"
                            ...
                            <option value="DNI"
                                {{ old('document_type', $patient->document_type ?? '') == 'DNI' ? 'selected' : '' }}>
                                DNI
                            </option>
                            <option value="NIE"
                                {{ old('document_type', $patient->document_type ?? '') == 'NIE' ? 'selected' : '' }}>
                                NIE</option>
                            <option value="Pasaporte"
                                {{ old('document_type', $patient->document_type ?? '') == 'Pasaporte' ? 'selected' : '' }}>
                                Pasaporte
                            </option>
                        </select>
                        <div class="min-h-[20px]">
